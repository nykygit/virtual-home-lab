# Rename the computer to WEB1
Rename-Computer -NewName "WEB1" -Restart

# Configure Static IP
New-NetIPAddress –IPAddress 192.168.1.106 -DefaultGateway 192.168.1.1 -PrefixLength 24 -InterfaceIndex (Get-NetAdapter).InterfaceIndex
